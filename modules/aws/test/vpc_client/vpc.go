...
import (
	"fmt"
	"github.com/openshift-online/ocm-common/module/aws/aws_client"
...
func (vpc *VPC) CreateVPCChain(zones ...string) (*VPC, error) {
	...
	_, err = vpc.AWSClient.ModifyVpcDnsAttribute(*respVpc.Vpc.VpcId, consts.VpcDnsHostnamesAttribute, true)
	if err != nil {
