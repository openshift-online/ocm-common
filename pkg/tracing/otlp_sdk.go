...
func ConfigureOpenTelemetryTracer(ctx context.Context, logger logr.Logger, serviceName string, serviceVersion string, resourceAttrs ...attribute.KeyValue) (func(context.Context) error, error) {
